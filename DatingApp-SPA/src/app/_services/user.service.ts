...
getUsers(page?, itemsPerPage?, userParams?, likes?): Observable<PaginatedResult<User[]>> {
...
sendLike(id: number, recipientId: number) {
  return this.httpClient.post(this.baseUrl + '/' + id + '/like/' + recipientId, {});
}
...
getMessageThread(id: number, recipientId: number) {
  return this.httpClient.get<Message[]>(this.baseUrl + '/' + id + '/messages/thread/' + recipientId);
}

sendMessage(id: number, message: Message) {
  return this.httpClient.post(this.baseUrl + '/' + id + '/messages', message);
}
